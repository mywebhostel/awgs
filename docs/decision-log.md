...
| 2026-06-07 | Add public change and version logs as public MDX content rendered by site routes. | Active | `content/public/changelog.mdx`; `content/public/version-log.mdx`; `src/app/changelog/page.tsx`; `src/app/versions/page.tsx` | Makes repository changes and publication versions visible to public readers without adding normative requirements. |
