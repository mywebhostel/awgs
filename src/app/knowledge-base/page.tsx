  ...
  return (
    <div className="mx-auto max-w-7xl space-y-10 px-4 py-10 sm:px-6 lg:px-8">
      <SectionHeader
        ...
        title="AWGS Knowledge Base"
        description="A structured home for future implementation notes, assessment playbooks, and practical guidance derived from the standard."
      />
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-lg border border-slate-200 bg-white p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Future articles can live under `/knowledge-base/[slug]` and link back to the relevant AWGS principles, domains, levels, and assessment model.
          </p>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-6">
